...
/**
 * This component loads the master ad script for multiple ad formats like Pop-unders and Social Bars.
 * The ad network script is designed to be loaded once to manage all its ad placements globally.
 */
export const GlobalAdLoader: React.FC = () => {
    useEffect(() => {
