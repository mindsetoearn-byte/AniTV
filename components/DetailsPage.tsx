          ...
          <div className="animate-fadeIn" style={{ animationDelay: '400ms' }}>
            ...
            <div className="space-y-3">
              {anime.episodes.map((episode, index) => (
                <div 
                  key={episode.id} 
                  className="bg-gray-800 p-4 rounded-lg flex items-center justify-between transition-all duration-300 hover:bg-gray-700/80 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-500/10 animate-slideInUp"
                ...
                >
                  ...
                  <button 
                    onClick={() => handleWatchClick(episode.watchUrl)}
